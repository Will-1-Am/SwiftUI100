//
//  ContentView.swift
//  WordScramble - Chalenge 3 - Put a text view below the List so you can track and show the player’s score for a given root word. How you calculate score is down to you, but something involving number of words and their letter count would be reasonable.
//
...
struct ContentView: View {
    ...
    func calculateScore() {
        //Challeng 3 - Give points for word length
        ...
        //Challeng 3 - Give points for number of words created
    ...
    var body: some View {
        ...
        NavigationView{
            ...
            VStack{
                ...
                // Challenge 3 - Text views for score and stats
                Text(usedWords.count == 1 ? "You have created \(usedWords.count) word" : "You have created \(usedWords.count) words" )
                Text("Score is: \(score)")
            }
