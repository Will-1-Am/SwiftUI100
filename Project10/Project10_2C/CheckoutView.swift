...
struct CheckoutView: View {
    ...
    //Challenge 2 - Create an alertTitle State to reuse the existing code
    ...
    func placeOrder() {
        ...
        URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            //Challenge 2 - Show a helpful error message if something like internet connection down.
            if let error = error {
            ...
            //Challenge 2 - title also needs setting here
